...
const { generateChatResponse, invokeTool, saveToDatabase } = proxyActivities<typeof activities>({
...
export const getConversationQuery = defineQuery<ChatMessage[]>('getConversation');
